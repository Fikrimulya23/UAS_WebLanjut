...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url(); ?>/assets/user_theme/images/favicon-32x32.png"
        sizes="32x32" />
    <link rel="icon" type="image/png" href="<?= base_url(); ?>/assets/user_theme/images/favicon-16x16.png"
        sizes="16x16" />
    <title>Travel</title>
    <!--stylesheet-->
    ...
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet"
        type="text/css">
    <link href="<?= base_url(); ?>/assets/user_theme/styles/styles.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url(); ?>/assets/user_theme/styles/custom-responsive-styles.css" rel="stylesheet"
        type="text/css">
    <!--scripts-->
    <script type="text/javascript" src="<?= base_url(); ?>/assets/user_theme/scripts/jquery-3.2.1.min.js"></script>
    <script type="text/javascript" src="<?= base_url(); ?>/assets/user_theme/scripts/all-plugins.js"></script>
    <script type="text/javascript" src="<?= base_url(); ?>/assets/user_theme/scripts/plugins-activate.js"></script>
</head>
...
<body id="page-top">
    ...
    <section id="Banner" class="content-section">
        <div class="container content-wrap text-center">
            ...
            <a href="/logout" class="btn btn-primary btn-xl">logout</a>
        </div>
        ...
        <div class="container">
            ...
            <div class="portfolio-wrapper clearfix">
                <a class="each-portfolio" data-fancybox="gallery"
                    href="<?= base_url(); ?>/assets/user_theme/images/p-two.jpeg">
                    <div class="content hover-cont-wrap">
                        <div class="content-overlay"></div>
                        <img class="content-image" src="<?= base_url(); ?>/assets/user_theme/images/p-two.jpeg">
                ...
                <a class="each-portfolio" data-fancybox="gallery"
                    href="<?= base_url(); ?>/assets/user_theme/images/p-three.jpeg">
                    <div class="content hover-cont-wrap">
                        <div class="content-overlay"></div>
                        <img class="content-image" src="<?= base_url(); ?>/assets/user_theme/images/p-three.jpeg">
                        <div class="content-details fadeIn-bottom">
                            <h5 class="p-title">Title</h5>
                            <p class="p-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                            <span class="zoom"><i class="fa fa-search-plus"></i></span>
                ...
                <a class="each-portfolio" data-fancybox="gallery"
                    href="<?= base_url(); ?>/assets/user_theme/images/p-four.jpeg">
                    <div class="content hover-cont-wrap">
                        <div class="content-overlay"></div>
                        <img class="content-image" src="<?= base_url(); ?>/assets/user_theme/images/p-four.jpeg">
                        <div class="content-details fadeIn-bottom">
                            <h5 class="p-title">Title</h5>
                            <p class="p-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                            <span class="zoom"><i class="fa fa-search-plus"></i></span>
                ...
                <a class="each-portfolio" data-fancybox="gallery"
                    href="<?= base_url(); ?>/assets/user_theme/images/p-five.jpeg">
                    <div class="content hover-cont-wrap">
                        <div class="content-overlay"></div>
                        <img class="content-image" src="<?= base_url(); ?>/assets/user_theme/images/p-five.jpeg">
                        <div class="content-details fadeIn-bottom">
                            <h5 class="p-title">Title</h5>
                            <p class="p-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                            <span class="zoom"><i class="fa fa-search-plus"></i></span>
                ...
                <a class="each-portfolio" data-fancybox="gallery"
                    href="<?= base_url(); ?>/assets/user_theme/images/p-six.jpeg">
                    <div class="content hover-cont-wrap">
                        <div class="content-overlay"></div>
                        <img class="content-image" src="<?= base_url(); ?>/assets/user_theme/images/p-six.jpeg">
                        <div class="content-details fadeIn-bottom">
                            <h5 class="p-title">Title</h5>
                            <p class="p-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                            <span class="zoom"><i class="fa fa-search-plus"></i></span>
                    ...
                    <div id="customers-testimonials" class="owl-carousel">
                        <div class="item">
                            <div class="shadow-effect">
                                <img class="img-circle" src="<?= base_url(); ?>/assets/user_theme/images/sarah.jpg"
                                    alt="">
                        ...
                        <div class="item">
                            <div class="shadow-effect">
                                <img class="img-circle" src="<?= base_url(); ?>/assets/user_theme/images/tangelia.jpg"
                                    alt="">
                        ...
                        <div class="item">
                            <div class="shadow-effect">
                                <img class="img-circle" src="<?= base_url(); ?>/assets/user_theme/images/john-doe.jpg"
                                    alt="">
                        ...
                        <div class="item">
                            <div class="shadow-effect">
                                <img class="img-circle" src="<?= base_url(); ?>/assets/user_theme/images/amy.jpg"
                                    alt="">
                        ...
                        <div class="item">
                            <div class="shadow-effect">
                                <img class="img-circle" src="<?= base_url(); ?>/assets/user_theme/images/daniel.jpg"
                                    alt="">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="contact-wrapper">
                        ...
                        <div class="address-block">
                            ...
                            <div class="c-detail">
                                <span class="c-icon"><i class="fa fa-map-marker" aria-hidden="true"></i></span><span
                                    class="c-info">&nbsp;98 Berry - Cheyenne, CO 80810</span>
                            </div>
                            <div class="c-detail">
                                <span class="c-icon"><i class="fa fa-phone" aria-hidden="true"></i></span><span
                                    class="c-info">+123 4567 8987</span>
                            </div>
                            <div class="c-detail">
                                <span class="c-icon"><i class="fa fa-envelope" aria-hidden="true"></i></span><span
                                    class="c-info">email@yourdomain.com</span>
